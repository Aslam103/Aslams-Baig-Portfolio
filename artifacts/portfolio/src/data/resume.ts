...
export const resumeData: ResumeData = {
  ...
  experience: [
    ...
    {
      role: "Office Coordinator & Administrative Executive",
      company: "Zakat Center India – Hyderabad Unit",
      location: "Hyderabad",
      period: "2 Years",
      bullets: [
        "Managed day-to-day office administration, documentation, and operational activities.",
        "Handled accounting records, vouchers, expense tracking, and financial reconciliation.",
        "Coordinated events, educational programs, and skill development initiatives.",
        "Organized interviews and conducted Level 1 & Level 2 candidate/beneficiary screening and document verification.",
        "Provided counselling and support to beneficiaries for education, self-employment, and skill development programs.",
        "Maintained reports, databases, and MIS using Microsoft Excel and Google Sheets.",
      ],
    },
    {
      role: "Technology Educator & Administrative Support",
      company: "Freelance, Schools & Community Programs",
      location: "Hyderabad / Yavatmal",
      period: "Various",
      bullets: [
        "Delivered computer literacy and ICT training for school students, supporting hands-on lab instruction and practical learning.",
        "Produced digital marketing assets and visual storytelling to boost engagement for small business and training initiatives.",
        "Managed IT support, PC repair, networking, and lab operations to reduce downtime and improve learner access.",
        "Supported accounting, inventory control, and administrative workflows for classroom and community programs.",
      ],
    },
  ],
  projects: [
